    ...
    <div class="container">
        <div class="row gy-40 g-sm-40 g-lg-32 mb-40">
            <div class="col-sm-6 col-lg-3 order-sm-1 order-lg-0">
                <a href="index.html" class="footer-logo">
                    <img alt="Huntee.net logo" src="{{ asset('images/svg/huntee.svg') }}" width="205" height="61">
                </a>
            </div>
            <div class="col-sm-6 col-lg-3 order-sm-3 order-lg-0">
                <h3 class="mb-3 mb-lg-4 pb-lg-2">Kontakt</h3>
                <p><a href="mailto:hello@huntee.net">hello@huntee.net</a></p>
                <p><a href="tel:+420702822228">+420 702 822 228</a></p>
            </div>
            <div class="col-sm-6 col-lg-3 order-sm-4 order-lg-0">
                <h3 class="mb-3 mb-lg-4 pb-lg-2">Užitečné odkazy</h3>
                <p><a href="registrace/lovec.html">Hledat zaměstnance</a></p>
                <p><a href="registrace/adept.html">Vytvořit pracovní profil</a></p>
                <p><a href="registrace/adept.html">Vytvořit životopis</a></p>
                <p><a href="blog.html">Blog</a></p>
            </div>
            <div class="col-sm-6 col-lg-3 order-sm-2 order-lg-0">
                <h3 class="mb-3 mb-lg-4 pb-lg-2">Sociální sítě</h3>
                <div class="d-flex gap-20">
                    <a href="https://www.facebook.com/profile.php?id=61552017354947" target="_blank"
                    ...
                    <a href="https://www.instagram.com/huntee_cz/" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://www.linkedin.com/company/huntee-cz/" target="_blank"
        ...
        <div class="row gy-20 gx-lg-40 mt-lg-80 pt-xxl-4 align-items-center">
            ...
            <div
                ...
                <a href="stranka/obchodni-podminky.html">Obchodní podmínky</a>
                <a href="stranka/zpracovani-osobnich-udaju.html">Zpracování osobních údajů</a>
            </div>
            <figure
                ...
                <img class="img-fluid" alt="VISA" src="images/svg/visa-white.svg" width="74"
                    height="24">
                <img class="img-fluid" alt="Mastercard" src="images/svg/mastercard.svg" width="45"
                    height="28">
            </figure>
        </div>
    </div>
