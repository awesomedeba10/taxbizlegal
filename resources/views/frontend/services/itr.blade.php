...
@section('content')
    <main class="flex-grow-1">
        <section class="services-intro nav-bg mod-items-center mod-my-12 mod-flex mod-justify-center mod-relative">
            <div class="mod-items-center mod-px-24 mod-grid-12 mod-w-full">
                ...
                <div class="section-image mod-overflow-hidden" data-fade="in" style="opacity: 1; visibility: inherit;">
                ...
                <div class="section-content mod-pr-12">
            ...
            <div class="container">
                <div class="row mb-40 mb-lg-3">
                    <div class="col-lg-8">
                        ...
                        <p class="text-lg mb-4">Discover expert tips and guides to simplify tax filing and maximize your savings.</p>
                    </div>
                ...
                <div class="row g-3 g-md-4 g-lg-40">
                    <div class="col-6">
                        <article class="card card--lg card--white h-100">
                            <figure class="card-figure">
                                <img class="card-img-top lazyloaded" alt=""
                                    src="{{ asset('images/img/1F-Blog-36.jpg') }}" width="600" height="400"
                                    data-src="{{ asset('images/img/1F-Blog-36.jpg') }}">
                            </figure>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h2 class="card-title mb-3 mb-sm-4">
                                    <a href="blog/9-nejhorsich-sefu-a-jak-se-s-nimi-vyporadat.html"
                                        class="stretched-link">
                                        Navigating India's Income Tax: Choosing Between the Old and New Regimes
                                    </a>
                                </h2>
                                <p class="text-lg mb-4">Explore the key differences between India's old and new income tax regimes, including updated tax slabs, exemptions, and deductions, to make an informed decision on which option best suits your financial situation.</p>
                                {{-- <div
                                ...
                                <div
                                    ...
                                    <span class="badge badge-xl">Income Tax</span>
                                    <span class="badge badge-xl">Savings Scheme</span>
                                </div>
                            </div>
                        </article>
                    </div>
                    <div class="col-6">
                        <article class="card card--lg card--white h-100">
                            <figure class="card-figure">
                                <img class="card-img-top lazyloaded" alt=""
                                    src="{{ asset('images/img/65a7a7555097a-under-the-old-tax-regime--there-were-numerous-tax-deductions-and-exemptions-offered-under-different-170923586-16x9.avif') }}" width="600" height="400"
                                    data-src="{{ asset('images/img/65a7a7555097a-under-the-old-tax-regime--there-were-numerous-tax-deductions-and-exemptions-offered-under-different-170923586-16x9.avif') }}">
                            </figure>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h2 class="card-title mb-3 mb-sm-4">
                                    <a href="blog/9-nejhorsich-sefu-a-jak-se-s-nimi-vyporadat.html"
