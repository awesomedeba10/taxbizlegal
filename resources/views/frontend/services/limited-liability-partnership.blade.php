    ...
    <div
        ...
        <div class="section-heading">
            ...
            <h1 class="section-title mod-font-bold mod-leading-semi-loose mod-space-light-semi mod-mb-8" data-fade="up">
                Register Your <span class="text-blue">Limited Liability Partnership</span> & Unlock Growth
                Opportunities!</h1>
    ...
    <nav
        ...
        <div
            ...
            <div class="mod-whitespace-nowrap mod-py-4 mod-sticky mod-left-0 mod-pl-6">
                <span class="services-nav-title mod-pl-6 mod-pr-3 mod-border-r-sm mod-contents">LLP</span>
            </div>
        ...
        <div>
            <h1
                ...
                <div class="mod-text-s-44">
                    For your <span class="text-blue">Limited Liability Partnership</span>
                </div>
            </h1>
            <p class="mod-nav-text mod-mt-2 mod-leading-loose mod-text-center">
                Get your Limited Liability Partnership registered effortlessly with our tailored pricing plans.
                Start your
                journey today!
            </p>
        </div>
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-6 col-xxl-5 sm:mod-order-2">
            <div class="mod-py-8">
                ...
                <h1 class="mod-text-s-24">All you need to know about Limited Liability Partnership Registration
                </h1>
