...
<section
    ...
    <nav
        ...
        <div
            ...
            <div class="mod-whitespace-nowrap mod-py-4 mod-sticky mod-left-0 mod-pl-2">
                <span class="services-nav-title mod-pl-6 mod-pr-3 mod-border-r-sm mod-contents">ONE PERSON
                    COMPANY</span>
            </div>
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-6 col-xxl-5 sm:mod-order-2">
            <div class="mod-py-8">
                ...
                <p>A One Person Company (OPC) in India is a unique business structure that allows a single individual to
                    form and operate a company with limited liability. Introduced under the Companies Act, 2013, it
                    offers the benefits of a Private Limited Company while maintaining the simplicity of a sole
                    proprietorship. OPCs are ideal for solo entrepreneurs and small business owners who want full
                    control over their enterprise without taking on unlimited personal risk.</p>
                <p>To register an OPC, only one director and one member are required, and the same individual can act in
                    both capacities. The liability of the owner is limited to the amount of their share capital,
                    ensuring personal assets are protected in case of business loss. Once incorporated and the
                    Certificate of Incorporation is issued, the OPC can start its business activities. The registration
                    process is typically completed within 10 to 15 working days.</p>
                <p>Taxbizlegal.com provides comprehensive services for One Person Company registration, covering every
        ...
        <div class="section-content mod-grid-4">
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                ...
                <div class="item-content">
                    <h3 class="item-title">Limited Liability Protection</h3>
                    <p class="item-text">In an OPC, the sole owner’s personal assets remain protected from any
                        business-related financial risks or debts. This structure ensures that liability is limited only
                        to the amount invested in the business, offering a strong shield against unforeseen losses.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    ...
                    <p class="item-text">An OPC is recognized as a distinct legal entity under the law. This allows it
                        to operate independently of its owner, meaning it can own assets, open a bank account, sue or be
                        sued, and enter into legal contracts in its own name — just like a private limited company.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    <h3 class="item-title">Full Control with Structured Benefits</h3>
                    <p class="item-text">The OPC model empowers individual entrepreneurs by allowing 100% ownership and
                        decision-making authority, while still enjoying the operational structure, brand credibility,
                        and compliance benefits of a corporate entity.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    <h3 class="item-title">Perpetual Succession with Nominee</h3>
                    <p class="item-text">Even though it is owned by a single individual, an OPC does not cease to exist
                        upon the owner's death or incapacitation. A nominee director, appointed during incorporation,
                        ensures business continuity and legal succession, making the structure robust and future-ready.
                    </p>
                </div>
            </div>
        </div>
...
<section class="bg-blue-100 py-40 py-xxl-40" id="doc-required">
    <div class="doc-required container mod-flex mod-flex-col mod-gap-8">
        <h2 class="mod-font-semibold mod-text-s-28 mod-mb-0 mod-leading-semi-loose mod-space-light-semi">
            Documents Required for Registering <span class="text-blue">Your</span> One Person Company
        </h2>
        <div class="section-content mod-grid-12">
            ...
            <div class="items mod-grid-4">
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    ...
                    <p class="item-text">Passport Size Photograph and PAN Card of the Director</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">02.</div>
                    <p class="item-text">Identity Proof – Aadhaar Card / Voter ID / Driving License</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">03.</div>
                    <p class="item-text">Address Proof – Latest Bank Statement / Utility Bill (not older than 2 months)
                    </p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">04.</div>
                    <p class="item-text">Consent to Act as Director – Form DIR-2</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">05.</div>
                    <p class="item-text">Nominee’s Identity & Address Proof – PAN and Aadhaar Card</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">06.</div>
                    <p class="item-text">Consent of Nominee – Form INC-3</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">07.</div>
                    <p class="item-text">Registered Office Proof – Rent Agreement or Property Ownership Document</p>
                </div>
                <div class="mod-flex mod-flex-col mod-gap-2" data-fade="up">
                    <div class="item-number">08.</div>
                    <p class="item-text">No Objection Certificate (NOC) from Property Owner & Director’s DSC</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="mod-pr-8 mod-flex mod-flex-col">
            ...
            <div class="mod-grid mod-items-start mod-my-6">
                ...
                <div class="mod-grid-2 mod-gap-2">
                    ...
                    <span class="mod-items-center mod-py-2 mod-space-semi">Advance Tax Payment</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">Income Tax Return Filing</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">Tax Audit Report Filing (if applicable)</span>
                </div>
            </div>
            <div>
    ...
    <article class="banner bg-blue-100 mod-overflow-hidden py-40 px-4 p-lg-5 lg:mod-px-12 pb-xxl-4">
        <div class="row gy-32 gx-xl-40 mod-relative justify-content-center align-items-center">
            <div class="col-lg-12 d-flex flex-column mod-gap-8">
                <h2 class="display-6 fw-bold mb-0">Register your One Person Company with <span
                        class="text-blue mod-font-semibold">Us</span> in 5 Simple Steps</h2>
                <p class="text-lg mb-0 pe-xl-80 me-xxl-4 mod-w-5/6 sm:mod-w-full">Starting your own one person
                ...
                <div
                    ...
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        ...
                        <p class="mod-mt-1 text-gray-600">Share your documents with us, and we’ll verify them for the next steps in the process. Our team ensures everything is in order to move forward smoothly.
                        </p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            ...
                            <figcaption class="text-h6 mod-pl-3">2. Choose Your Company Name</figcaption>
                        </div>
                        <p class="mod-mt-1 text-gray-600">Select a unique name for your One Person Company. We’ll help you check if your desired name is available and assist you with the approval process.</p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            <span class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <p class="mod-mt-1 text-gray-600">We’ll prepare the necessary legal documents for your OPC, including the MOA and AOA, ensuring they are in compliance with the Companies Act.
                        </p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            ...
                            <figcaption class="text-h6 mod-pl-3">4. File Application with Registrar of Companies</figcaption>
                        </div>
                        <p class="mod-mt-1 text-gray-600">Once the documents are ready, we’ll file your application with the RoC for incorporation. We’ll take care of all the paperwork and filings on your behalf.</p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            <span class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <figcaption class="text-h6 mod-pl-3">5. Get Your Certificate of Incorporation</figcaption>
                        </div>
                        <p class="mod-mt-1 text-gray-600">Once the RoC approves your application, you’ll receive your official Certificate of Incorporation. You’ll now have a legally recognized One Person Company ready to operate.</p>
                    </figure>
                </div>
                <div>
                    <a class="btn-custom-medium" href="{{ route('front.contact') }}" target="_self">
