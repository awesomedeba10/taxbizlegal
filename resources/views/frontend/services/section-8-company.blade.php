<section class="services-intro nav-bg mod-items-center mod-w-full mod-my-12 mod-flex mod-justify-center mod-relative">
    <div
        ...
        <div class="section-heading">
            <p class="h5 text-primary mb-2">Start Your Section 8 Company with Ease!</p>
            <h1 class="section-title mod-font-bold mod-leading-semi-loose mod-space-light-semi mod-mb-8" data-fade="up">
                Register Your <span class="text-blue">Section 8 Company</span> & Unlock Growth Opportunities!</h1>
    ...
    <nav
        ...
        <div
            ...
            <div class="mod-whitespace-nowrap mod-py-4 mod-sticky mod-left-0 mod-pl-6">
                <span class="services-nav-title mod-pl-6 mod-pr-3 mod-border-r-sm mod-contents">SECTION 8 COMPANY</span>
            </div>
        ...
        <div>
            <h1
                ...
                <div class="mod-text-s-44">
                    For your <span class="text-blue">Section 8 Company</span>
                </div>
            </h1>
            <p class="mod-nav-text mod-mt-2 mod-leading-loose mod-text-center">
                Get your Section 8 Company registered effortlessly with our tailored pricing plans. Start your
                journey today!
            </p>
        </div>
    </div>
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-6 col-xxl-5 sm:mod-order-2">
            <div class="mod-py-8">
                ...
                <h1 class="mod-text-s-24">All you need to know about Section 8 Company Registration</h1>
                <p>A Section 8 Company in India is a special type of non-profit organization formed under the provisions
                    of Section 8 of the Companies Act, 2013. It is registered with the objective of promoting commerce,
                    art, science, education, research, social welfare, religion, charity, or any other useful object.
                    The key feature of a Section 8 company is that it operates without the intention of profit. Any
                    income or profits generated by a Section 8 company must be used to further its objectives rather
                    than being distributed to its members. These companies enjoy certain privileges and exemptions from
                    the provisions applicable to private limited companies and public limited companies.</p>
                <p>Section 8 companies can be formed by anyone who intends to work towards social, charitable, or
                    educational causes. It can also be a trust or a society, but with the legal recognition and
                    credibility of a company structure.</p>
                <p>Taxbizlegal.com is a trusted platform that provides end-to-end services for Section 8 Company
        ...
        <div class="section-content mod-grid-4">
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                ...
                <div class="item-content">
                    <h3 class="item-title">Non-Profit Objective</h3>
                    <p class="item-text">The company must use its income for charitable purposes, making it ideal for
                        socially-driven businesses.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    ...
                    <p class="item-text">Like other companies, the liability of members is limited to their shares or
                        the guarantee they provide, offering protection to personal assets.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    <h3 class="item-title">Corporate Structure & Credibility</h3>
                    <p class="item-text">The company benefits from a formal structure and legal recognition, which
                        provides credibility and trust for donations, grants, and sponsorships.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    ...
                    <p class="item-text">Section 8 companies can avail of various tax exemptions, such as exemption
                        under Section 11 (Income Tax Act), provided they fulfill the necessary requirements.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    <h3 class="item-title">Government Grants & Donations</h3>
                    <p class="item-text">Section 8 companies are eligible for government grants and public donations
                        that might not be available to other non-profits.</p>
                </div>
            </div>
            <div class="mod-flex mod-flex-col mod-gap-4 xl:mod-pr-20 lg:mod-pr-8 sm:mod-pr-4 sm:mod-flex-row"
                data-fade="up"
                ...
                <div class="item-content">
                    <h3 class="item-title">Perpetual Succession & Flexible Governance</h3>
                    <p class="item-text">The company continues to exist even with changes in members or management and
                        allows more adaptable governance compared to trusts or societies.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="container my-80 my-xxl-120" id="resources">
    ...
    <h1 class="display-6 mb-32 mod-font-semibold mod-text-s-24">
        Key Features of a <span class="text-primary mod-font-bold">Section 8 Company</span>
    </h1>
    <div class="row gy-40 gx-lg-40">
        <div class="col-lg-4">
            <div class="d-flex flex-column gap-12 gap-lg-3 mx-auto">
                <h2 class="mb-0">Non-Profit <span class="text-primary mod-font-bold">Objective</span></h2>
                <p class="mb-0 text-lg mod-text-justify">A Section 8 company is formed with the primary goal of promoting charitable, social, educational, or environmental objectives. Any surplus generated must be used to advance these causes rather than being distributed to its members or shareholders.</p>
                <p class="mb-0 text-lg mod-text-justify">This focus on reinvestment and social welfare ensures that all operations are aligned with its core mission of public good and sustainable development.</p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="d-flex flex-column gap-12 gap-lg-3 mx-auto">
                <h2 class="mb-0">Limited Liability & <span class="text-primary mod-font-bold">Membership</span></h2>
                <p class="mb-0 text-lg mod-text-justify">The liability of members in a Section 8 company is limited either by shares or by guarantee. They are not personally responsible for the debts of the company beyond their agreed contribution.</p>
                <p class="mb-0 text-lg mod-text-justify">Additionally, membership is voluntary and open to anyone who aligns with the company’s non-profit vision, promoting inclusivity and participation.</p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="d-flex flex-column gap-12 gap-lg-3 mx-auto">
                <h2 class="mb-0">Governance & <span class="text-primary mod-font-bold">Tax Benefits</span></h2>
                <p class="mb-0 text-lg mod-text-justify">A Section 8 company requires a minimum of two directors and two shareholders. It operates under a board of directors and must follow proper corporate governance norms as per law.</p>
                <p class="mb-0 text-lg mod-text-justify">If compliant with the Income Tax Act, these companies may enjoy various tax exemptions, further encouraging charitable activities and public trust in their operations.</p>
            </div>
        </div>
    </div>
...
<section class="bg-blue-100 py-40 py-xxl-40" id="doc-required">
    <div class="doc-required container mod-flex mod-flex-col mod-gap-8">
        <h2 class="mod-font-semibold mod-text-s-28 mod-mb-0 mod-leading-semi-loose mod-space-light-semi">
            Documents Required for Registering <span class="text-blue">Your</span> Section 8 Company
        </h2>
...
<section class="container my-40" id="compliances">
    <h1 class="display-6 mb-32 mod-font-semibold mod-text-s-28">Annual Compliance for Section 8 Company
    </h1>
    ...
    <div class="mod-grid mod-mt-4 mod-gap-8 mod-grid-template-col-2 sm:mod-grid-template-col-1">
        <div class="mod-pr-8 mod-flex mod-flex-col sm:mod-order-2">
            ...
            <p class="mod-mt-2 mod-pr-24">
                For Section 8 Companies, maintaining compliance is essential not just for legal validity, but also to uphold trust,
                ensure uninterrupted NGO operations, and continue availing tax exemptions and grants. Proper compliance supports
                transparency and strengthens your credibility with donors, stakeholders, and regulators.
            </p>
            <div class="mod-grid mod-items-start mod-my-6">
                ...
                <div class="mod-grid-2 mod-gap-2">
                    ...
                    <span class="mod-items-center mod-py-2 mod-space-semi">Filing of TDS Returns</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">Income Tax Filing under ITR-7</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">Maintaining Books of Accounts</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">FCRA Compliance (for foreign contributions)</span>
                    <span class="mod-items-center mod-py-2 mod-space-semi">GST Filing (if registered under GST)</span>
                </div>
            </div>
            <div>
        ...
        <div class="mod-px-2 mod-flex mod-flex-col mod-gap-2 sm:mod-order-1">
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
                ...
                <p class="mod-ml-16 mod-mb-0 mod-text-right">Form AOC-4 must be filed within 30 days from the AGM.</p>
            </div>
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
                <h3 class="mod-mb-0">Annual Return Filing</h3>
                <p class="mod-ml-16 mod-mb-0 mod-text-right">Form MGT-7 should be filed within 60 days from the AGM.</p>
            </div>
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
                <h3 class="mod-mb-0">Income Tax Returns</h3>
                <p class="mod-ml-16 mod-mb-0 mod-text-right">Form ITR-7 is due by 31st July of the assessment year.</p>
            </div>
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
                <h3 class="mod-mb-0">Filing of Director’s Report</h3>
                <p class="mod-ml-16 mod-mb-0 mod-text-right">Included as part of the AGM process.</p>
            </div>
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
                <h3 class="mod-mb-0">Board Meetings</h3>
                <p class="mod-ml-16 mod-mb-0 mod-text-right">At least one board meeting every 120 days is required.</p>
            </div>
            <div class="mod-flex mod-items-center mod-justify-space-between mod-px-2 mod-py-4 mod-border-bottom-2">
    ...
    <article class="banner bg-blue-100 mod-overflow-hidden py-40 px-4 p-lg-5 lg:mod-px-12 pb-xxl-4">
        <div class="row gy-32 gx-xl-40 mod-relative justify-content-center align-items-center">
            <div class="col-lg-12 d-flex flex-column mod-gap-8">
                <h2 class="display-6 fw-bold mb-0">Register your Section 8 Company with <span
                ...
                <div
                    ...
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        ...
                        <p class="mod-mt-1 text-gray-600">Obtain a valid DSC for all proposed directors. It’s mandatory for filing incorporation forms digitally with the MCA.</p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            <span class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <p class="mod-mt-1 text-gray-600">Choose a unique name and apply via SPICe+ Part A. Ensure the name aligns with Section 8 naming rules and social objectives</p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            <span class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <p class="mod-mt-1 text-gray-600">Draft MOA and AOA, and submit them along with SPICe+ Part B, INC-9 (declaration), and DIR-2 (consent of directors)
                        </p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            ...
                            <figcaption class="text-h6 mod-pl-3">4. Obtain License from Central Government</figcaption>
                        </div>
                        <p class="mod-mt-1 text-gray-600">Apply for the Section 8 license along with incorporation documents. The MCA issues the license after reviewing your company objectives.</p>
                    </figure>
                    <figure class="mb-0 mod-flex mod-flex-col mod-items-start mod-text-left mod-gap-4">
                        <div class="mod-flex ">
                            <span class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <figcaption class="text-h6 mod-pl-3">5. Certificate of Incorporation</figcaption>
                        </div>
                        <p class="mod-mt-1 text-gray-600">Once approved, the Registrar of Companies (RoC) issues the Certificate of Incorporation, officially recognizing your Section 8 company.</p>
                    </figure>
                </div>
                <div>
