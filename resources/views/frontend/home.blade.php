...
<main class="flex-grow-1">
                ...
                <div class="splide__list">
                    ...
                    <div class="splide__slide slideshow-slide">
                        <div class="slideshow-content">
                            ...
                            <p class="mb-0 slideshow-fade">Register your company with ease and compliance. Get expert guidance, end-to-end documentation, and fast approvals.</p>
                        ...
                        <div class="slideshow-media slideshow-media--custom">
                            <figure class="slideshow-figure slideshow-figure--custom">
                                <img alt="Kdo řekl, že novou práci musíte hledat?"
                                    class="slideshow-img slideshow-img--custom" src="images/img/home/zivotopis.png"
                    ...
                    <div class="splide__slide slideshow-slide">
                        <div class="slideshow-content">
                            ...
                            <h2 class="h1 mb-0" data-slideshow-title>File Your Income Tax Returns Accurately On Time</h2>
                            <p class="mb-0 slideshow-fade">Avoid penalties and maximize tax savings with our expert-assisted ITR filing service.</p>
                            <div class="slideshow-fade">
                                <a href="registrace/adept.html" class="d-block btn btn-lg btn-primary">File ITR Now</a>
                            </div>
                        </div>
                        <div class="slideshow-media slideshow-media--a4">
                            <figure class="slideshow-figure slideshow-figure--a4">

                                <img alt="Vytvořte profesionální životopis"
                                    class="slideshow-img slideshow-img--a4 lazyloaded"
                                    src="images/img/home/zivotopis.png"
                                    height="1442" data-src="images/img/home/zivotopis.png">
                            </figure>
                        </div>
                    </div>
                    <div class="splide__slide slideshow-slide">
            ...
            <div class="row gy-3 gy-md-0 gx-lg-40">
                <div class="col-md-4">
                    ...
                    <div class="h-100 shadow-primary rounded-35 bg-white p-4 p-lg-32">
                        <p class="display-6 fw-bold mb-2 text-primary" data-counter="302">0</p>
                        <p class="mb-0">Firem u nás hledá<br>zaměstnance</p>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="h-100 shadow-primary rounded-35 bg-white p-4 p-lg-32">
                        <p class="display-6 fw-bold mb-2 text-primary" data-counter="126">0</p>
                        <p class="mb-0">Personalistů dnes prohledávalo knihovnu kontaktů</p>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="h-100 shadow-primary rounded-35 bg-white p-4 p-lg-32">
                        <p class="display-6 fw-bold mb-2 text-primary"><span data-counter="5">0</span> minut</p>
                        <p class="mb-0">Průměrná doba tvorby<br>pracovního profilu</p>
                    </div>
    ...
    <section class="container my-80">
        <h2 class="h6 mb-3 mb-lg-32 text-center">Hlavní partneři</h2>
        <div class="row g-3 gx-lg-5 gy-xxl-4 gx-xxl-80 justify-content-center align-items-center">
            ...
            <div class="col-4 col-lg-auto text-center">
                <img alt="Equans" class="img-fluid opacity-40" src="images/svg/partners/equans.svg"
                    width="150" height="150">
            </div>
        </div>
    </section>
    ...
    <section class="container my-80 my-xxl-120">
        <article class="banner bg-blue-100 pb-40 px-4 p-lg-5 p-xxl-80">
            <div class="row gy-4 gx-lg-4 justify-content-center justify-content-lg-between align-items-center">
                <div class="col-md-9 col-lg-8 d-flex flex-column gap-3 gap-lg-4">
                    <h2 class="display-6 fw-bold mb-0">Why Do Customers Love Us?</h2>
                    <p class="text-lg mb-0">We provide hassle-free legal and financial solutions with expert assistance, ensuring transparency and efficiency at every step.</p>
                    <div class="row gx-3 gx-lg-40 svg-scale scale-4 text-sm">
                        <div class="col-4">
                            <figure class="mb-12 text-primary"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22ZM12 20C12.9 20 13.7667 19.8542 14.6 19.5625C15.4333 19.2708 16.2 18.85 16.9 18.3L5.7 7.1C5.15 7.8 4.72917 8.56667 4.4375 9.4C4.14583 10.2333 4 11.1 4 12C4 14.2333 4.775 16.125 6.325 17.675C7.875 19.225 9.76667 20 12 20ZM18.3 16.9C18.85 16.2 19.2708 15.4333 19.5625 14.6C19.8542 13.7667 20 12.9 20 12C20 9.76667 19.225 7.875 17.675 6.325C16.125 4.775 14.2333 4 12 4C11.1 4 10.2333 4.14583 9.4 4.4375C8.56667 4.72917 7.8 5.15 7.1 5.7L18.3 16.9Z" />
                                </svg></figure>
                            <h3 class="h6 mb-2">Affordable Professional Services</h3>
                            <p>Get expert legal and financial assistance at competitive prices, tailored to your needs.</p>
                        </div>
                        <div class="col-4">
                            <figure class="mb-12 text-primary"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" fill="none" viewBox="0 0 20 21">
                                    <path fill="currentColor"
                                        d="M12.7917 14.0417L13.8542 12.9792L10.75 9.875V5.5H9.25V10.5L12.7917 14.0417ZM10 18.5C8.89756 18.5 7.86153 18.2917 6.89192 17.875C5.92231 17.4583 5.07292 16.8854 4.34375 16.1562C3.61458 15.4271 3.04167 14.5767 2.625 13.605C2.20833 12.6334 2 11.5952 2 10.4905C2 9.38571 2.20833 8.34722 2.625 7.375C3.04167 6.40278 3.61458 5.55556 4.34375 4.83333C5.07292 4.11111 5.92332 3.54167 6.89496 3.125C7.86661 2.70833 8.90481 2.5 10.0095 2.5C11.1143 2.5 12.1528 2.71 13.1251 3.13C14.0974 3.55 14.9432 4.12 15.6625 4.84C16.3817 5.56 16.9511 6.40667 17.3707 7.38C17.7902 8.35333 18 9.39333 18 10.5C18 11.6024 17.7917 12.6385 17.375 13.6081C16.9583 14.5777 16.3889 15.4271 15.6667 16.1562C14.9444 16.8854 14.0963 17.4583 13.1223 17.875C12.1482 18.2917 11.1075 18.5 10 18.5ZM10.0099 17C11.8082 17 13.3395 16.3646 14.6037 15.0938C15.8679 13.8229 16.5 12.2884 16.5 10.4901C16.5 8.69177 15.8679 7.16052 14.6037 5.89631C13.3395 4.6321 11.8082 4 10.0099 4C8.21165 4 6.67708 4.6321 5.40625 5.89631C4.13542 7.16052 3.5 8.69177 3.5 10.4901C3.5 12.2884 4.13542 13.8229 5.40625 15.0938C6.67708 16.3646 8.21165 17 10.0099 17Z" />
                                </svg></figure>
                            <h3 class="h6 mb-2">Diverse Expert Network</h3>
                        ...
                        <div class="col-4">
                            ...
                            <h3 class="h6 mb-2">Quick Customer Support</h3>
                            <p>We value your time—get responses to your queries within 24 hours* with dedicated support.</p>
                        </div>
                    </div>
                    <div>
                        <a href="{{ route('front.contact') }}"
                ...
                <div class="col-12 col-lg-4 col-xl-4 order-first order-lg-last">
                    <figure class="ratio text-primary mx-auto my-20"
    ...
    <section class="container my-80 mt-lg-120 mb-xxl-120">
        <div class="row gy-5 gx-20 gx-lg-40">
            <h2 class="display-6 fw-bold col-lg-4 pe-120 pe-lg-3 mb-2">Co o nás říkají naši uživatelé</h2>
                ...
                <blockquote class="rounded-2 bg-blue-100 px-4 pb-4 p-lg-32 pt-lg-40 px-xl-40 mb-0">
                    ...
                    <div class="row gx-4">
                        ...
                        <div class="col-12 col-lg-8 svg-scale scale-32 scale-lg-auto">
                            ...
                            <p class="text-h3 mt-1 mb-2 mb-sm-3 mt-lg-3">Huntee by měla být základní výbava každého
                                uchazeče o zamestnání.</p>
                            <cite class="text-h5 text-secondary">Monika, Náborářka</cite>
                        </div>
                    </div>
                </blockquote>
                ...
                <blockquote class="rounded-2 bg-blue-300 px-4 pb-4 p-lg-32 pt-lg-40 px-xl-40 mb-0">
                    ...
                    <div class="row gx-4">
                        ...
                        <div class="col-12 col-lg-8 svg-scale scale-32 scale-lg-auto">
                            ...
                            <p class="text-h3 mt-1 mb-2 mb-sm-3 mt-lg-3">Díky Huntee jsem objevil nový způsob
                                hledání práce.</p>
                            <cite class="text-h5 text-secondary">Jaroslav, Projektant</cite>
                        </div>
                    </div>
                </blockquote>
    ...
    <section class="bg-blue-100 py-80 py-xxl-120">
        <div class="container">
            <div class="row mb-40 mb-lg-3">
                <div class="col-lg-8">
                    <h2 class="lead mb-3">Huntee Blog</h2>
                    <p class="text-lg mb-4">Prozkoumejte tipy pro zájemce o práci nebo novinky ze světa pracovního
                        trhu.</p>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <a href="blog.html" class="btn btn-link icon-hover-right">
                        Všechny příspěvky
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path fill="currentColor"
                ...
                <div class="col-6">
                    <article class="card card--lg card--white h-100">
                        <figure class="card-figure">
                            <img class="card-img-top lazyloaded" alt="9 nejhorších šéfů a jak se s nimi vypořádat"
                                src="upload/blog/7b/9_nejhorsich_sefu.10x6.fit.q10.png" width="600"
                                height="400" data-src="upload/blog/7b/9_nejhorsich_sefu.620x400.fit.q85.png">
                        </figure>
                        <div class="card-body d-flex flex-column flex-grow-1">
                            <h2 class="card-title mb-3 mb-sm-4">
                                <a href="blog/9-nejhorsich-sefu-a-jak-se-s-nimi-vyporadat.html"
                            ...
                            <div
                                ...
                                <span class="badge badge-xl">Pracovní prostředí</span>
                            </div>
                        </div>
                    </article>
                </div>
                    ...
                    <article class="card card--lg card--white h-100">
                        <figure class="card-figure">
                            <img class="card-img-top lazyloaded"
                                alt="Jak odpovědět na otázku: Proč odcházíte ze své současné práce?"
                                src="upload/blog/5a/proc_odchazite_blog.10x6.fit.q10.png" width="600"
                                height="400" data-src="upload/blog/5a/proc_odchazite_blog.620x400.fit.q85.png">
                        </figure>
                        <div class="card-body d-flex flex-column flex-grow-1">
                            <h2 class="card-title mb-3 mb-sm-4">
                                <a href="blog/jak-odpovedet-na-otazku-proc-odchazite-ze-sve-soucasne-prace.html"
                                    class="stretched-link">
                                    Jak odpovědět na otázku: Proč odcházíte ze své současné práce?
                                </a>
                            </h2>
                            <div
                                class="card-text d-flex align-items-center gap-40 text-sm text-secondary icon-size-20 pt-1 mt-auto mt-md-0">
                            ...
                            <div
                                class="pt-40 pb-1 d-none d-md-inline-flex flex-wrap gap-3 position-relative z-1 mt-auto">
                                <span class="badge badge-xl">Pracovní pohovor</span>
                            </div>
                        </div>
                    </article>
                </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <span class="ms-auto caret"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path fill="#001C35" fill-rule="evenodd"
