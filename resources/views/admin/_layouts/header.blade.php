    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-right">
            ...
            <div class="header-element country-selector">
                <!-- Start::header-link --> <a href="javascript:void(0);" class="header-link" data-bs-toggle="modal"
                    data-bs-target="#countryModal"> <img src="{{ asset('images/crm/flags/us_flag.jpg') }}"
                        alt="img" class="rounded-circle header-link-icon"> <span
                        class="fw-semibold mb-0 lh-1">EN</span>
                </a>
            </div>
            <!-- End::header-element --> <!-- Start::header-element -->
            ...
            <div class="header-element notifications-dropdown">
                <!-- Start::header-link|dropdown-toggle --> <a aria-label="anchor" href="javascript:void(0);"
                    ...
                    id="messageDropdown" aria-expanded="false"> <i class="bx bx-bell header-link-icon"></i> <span
                                            ...
                                            <li class="dropdown-item">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <p class="mb-0 fw-semibold"><a href="notifications">Your
                                                                    Order Has Been
                                                                    Shipped</a></p>
                                                            <span
                                            ...
                                            <li class="dropdown-item">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div
                                                        class="flex-grow-1 d-flex align-items-center justify-content-between">
                                                        <div>
                                                            <p class="mb-0 fw-semibold"><a href="notifications">Order
                                            ...
                                            <li class="dropdown-item">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <p class="mb-0 fw-semibold"><a href="notifications">Order
                                                                    Delayed <span class="text-success">ID:
                                                                        7731116</span></a></p>
                                                            <span
                                                                class="text-muted fw-normal fs-12 header-notification-text">Order
