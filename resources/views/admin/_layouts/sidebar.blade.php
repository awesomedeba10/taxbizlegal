<aside class="app-sidebar sticky sticky-pin" id="sidebar">
    ...
    <div class="main-sidebar-header"> <a href="{{ route('admin.dashboard') }}" class="header-logo"> <img src="{{ asset('images/svg/tbl_logo.svg') }}" alt="logo" class="desktop-logo">
            ...
            <img src="{{ asset('images/svg/tbl_logo.svg') }}" alt="logo" class="desktop-white"> <img src="{{ asset('images/svg/tbl_logo.svg') }}" alt="logo" class="toggle-white"> </a> </div>
    ...
    <div class="main-sidebar" id="sidebar-scroll" data-simplebar="init">
                ...
                <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                    <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 8px 0px 80px;">
                            <!-- Start::nav -->
                            <nav aria-label="Main Navigation" class="main-menu-container nav nav-pills flex-column sub-open">
                                ...
                                <ul class="main-menu" style="margin-left: 0px; margin-right: 0px;">
                                    ...
                                    <li class="slide has-sub">
                                        <a href="javascript:void(0);" class="side-menu__item"> <i class="bx bx-task side-menu__icon"></i> <span class="side-menu__label">Enquiries<span class="badge bg-secondary-transparent ms-2">New</span></span>
                                            <i class="fe fe-chevron-right side-menu__angle"></i> </a>
        ...
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar" style="height: 65px; transform: translate3d(0px, 119px, 0px); display: block;"></div>
        </div>
    </div>
    <!-- End::main-sidebar -->
</aside>