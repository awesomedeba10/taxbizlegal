<form action="/registrace/adept" method="post" id="frm-adeptRegistrationForm-form" class="loadable loadable-overlayed ajax"
    ...
    <div class="form-floating required">
        <input 
            ...
            id="frm-enquiryForm-form-user-name" 
            required
    ...
    <div class="form-floating required">
        <select name="state" class="form-select" data-select=""
            id="frm-enquiryForm-form-user-state"
        ...
        <img src="{{ asset('images/svg/search.svg') }}" width="24" height="24" class="form-search-img input-addon-left">
        <label for="frm-enquiryForm-form-user-state"
            class="required form-text">State</label>
    </div>
