...
return [
    "private-limited-company" => [
        [
            ...
            "answer" => "A Private Limited Company is a legally recognized business structure in India that limits the liability of its shareholders. It requires a minimum of two members and can have up to 200 shareholders. This type of company provides credibility, limited liability protection, and ease of fundraising from investors."
        ],
        [
            "question" => "What are the key benefits of registering a Private Limited Company?",
            "answer" => "<p>Registering a Private Limited Company offers several advantages, including:</p>
                <ul>
        ...
        [
            "question" => "What are the minimum requirements for registering a Private Limited Company?",
            "answer" => "<p>To register a Private Limited Company in India, the following minimum requirements must
                    be met:</p>
                <ul>
        ...
        [
            ...
            'answer' => 'The registration process for a Private Limited Company in India typically takes 7 to 14
                        business days, depending on document submission and government processing times.'
        ],
        [
            'question' => 'Are the Company Incorporation Certificate and Registration Certificate the same?',
            'answer' => 'Yes, both the Company Incorporation Certificate and Registration Certificate refer to the
                    same document. Issued by the Ministry of Corporate Affairs (MCA), this certificate
                    confirms the legal registration of the company.'
        ],
        [
            'question' => 'Is a Private Limited Company required to comply with annual regulations?',
            'answer' => 'Yes, a Private Limited Company must fulfill annual compliance obligations, including
                    filing annual returns, conducting financial audits, and holding Annual General Meetings
                    (AGMs) as per regulatory requirements.'
        ],
        [
            'question' => 'How can I check if a company is registered in India?',
            'answer' => "To verify a company's registration status in India, visit the MCA portal and search using
                    the company’s name or Corporate Identification Number (CIN) in the official database."
        ],
        [
            'question' => 'What are the next steps after company incorporation?',
            'answer' => '<p>Once a company is incorporated, the Registrar of Companies (ROC) issues a Certificate of
